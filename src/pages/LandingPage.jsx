...
import deviceStreaming from "../images/watchAnywhere.png";
import childrenCreateProfile from "../images/childrenCreateProfiles.png";
import downloadShows from "../images/downloadShows.png";
    ...
    <>
      ...
      >
        <div className="flex justify-center items-center backdrop-brightness-50 align-center flex-col w-full my-[150]px mx-auto">
          ...
          <form
            className="w-[90%] md:w-[60%] flex align-center"
            onSubmit={(e) => handleSubmit(e)}
          >
            <input
              className="w-[70%] md:w-[80%] h-[70px] p-[20px] text-lg text-gray-800"
              placeholder="Email address"
              type="email"
              onChange={(e) => setEmail(e.target.value)}
            />
            <button
              className="w-[30%] md:w-[20%] h-[70px] text-[22px] text-white cursor-pointer bg-red-700"
              type="submit"
            >
              Get Started &gt;
            </button>
